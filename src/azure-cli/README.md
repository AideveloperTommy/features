...
```json
"features": {
    "ghcr.io/AideveloperTommy/features/azure-cli:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/AideveloperTommy/features/blob/main/src/azure-cli/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
