...
```json
"features": {
    "ghcr.io/AideveloperTommy/features/git:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/AideveloperTommy/features/blob/main/src/git/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
