...
```json
"features": {
    "ghcr.io/AideveloperTommy/features/docker-in-docker:2": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/AideveloperTommy/features/blob/main/src/docker-in-docker/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
